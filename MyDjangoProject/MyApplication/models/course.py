...
class Course(models.Model):
    ...
    TEACHER=[
        (0, 'Ernesto Fuentes Carrillo')
        (1, 'Pedro Alvarez Daza')
    ]
    ...
    practice_hours = models.DecimalField(null=True, blank=True, max_digits=5,

    decimal_places=2)

    laboratory_hours = models.DecimalField(null=True, blank=True, max_digits=5,
    ...
    def __str__(self):
        return " %s %s %s %s %s" % (self.curriculum, self.year, self.semester, self.code,
